...
public interface EgovBoardService {
	...
	*//**
	...
	void counterBoard(BoardVO vo) throws Exception;
...
//	BoardVO selectMainBoard(BoardDefaultVO searchVO) throws Exception;
	
	BoardVO selectMainBoard(BoardVO vo) throws Exception;
