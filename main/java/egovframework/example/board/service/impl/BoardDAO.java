...
public class BoardDAO extends EgovAbstractDAO {
	...
	*//**
	...
	public void counterBoard(BoardVO vo) throws Exception {
		update("boardDAO.counterBoard", vo);
	}
	*//**
	 * 글을 삭제한다.
	...
	*//**
	...
	public BoardVO selectMainBoard(BoardDefaultVO searchVO)  {
		return (BoardVO) select("boardDAO.selectMainBoard", searchVO);
	}
	
	public BoardVO selectMainBoard(BoardVO vo) throws Exception {
		return (BoardVO) select("boardDAO.selectMainBoard", vo);
	}
