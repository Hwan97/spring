...
<head>
	...
	<title>진진시스템(주)</title>
	<meta charset="utf-8">
	<!-- <link rel="stylesheet" type="text/css" href="../../css/pc/subpage.css"> -->
            ...
            <div class="content">
				<div class="content_header">
					...
					<ul class="location">
						...
						<li class="font-regular">제품소개</li>
						<li class="font-bold">ServerCraft</li>
					</ul>
				</div>
					...
					<div class="product_function">
						...
						<div class="function_box">
							<table class="function_table">
								...
								<tr>
									<th scope="row" class="category pt-25">실시간 디스플레이</th>
									<td class="text">
										<ul>
											<li class="spec_list">- 오류 및 경고메시지 한글로 실시간 디스플레이</li>
											<li class="spec_list">- 장애이력 유지 및 조회(유지기간 임의 성정), 이벤트 당시 시스템 상황 조회 및 분석</li>
											<li class="spec_list pb-25">- 성능이력 저장, 유지 및 지정된 시간대 조회 기능</li>
										</ul>
									</td>
								</tr>
								<tr>
									<th scope="row" class="category pt-25">프로세스 관리</th>
									<td class="text">
										<ul>
											...
											<li class="spec_list pb-25">- 프로세스 가동 이력 유지 및 특정 시간대 자료 조회</li>
										</ul>
									</td>
								</tr>
								<tr>
									<th scope="row" class="category pt-25">작업 관리</th>
									<td class="text">
										<ul>
											<li class="spec_list">- 주기적으로 수행항 작업에 대해 스케줄 지정</li>
											<li class="spec_list">- 작업이력 유지</li>
											<li class="spec_list pb-25">- Crontab 편집</li>
										</ul>
									</td>
								</tr>
								<tr>
									<th scope="row" class="category pt-25">백업 관리</th>
									<td class="text">
										<ul>
											...
											<li class="spec_list pb-25">- 백업관련 수행할 스크립트파일 지정</li>
										</ul>
									</td>
								</tr>
								<tr>
									<th scope="row" class="category pt-25">파일관리</th>
									<td class="text">
										<ul>
											<li class="spec_list">- Unix, Linux, Windows 서버에 대해 공통 윈도우 탐색기 형태의 파일 관리자 UI제공</li>
											<li class="spec_list pb-25">- 윈도우 탐색기 기능과 같은 파일 시스템 관리</li>
										</ul>
									</td>
								</tr>
								<tr>
									<th scope="row" class="category pt-25">서버자 관리</th>
									<td class="text">
										<ul>
											<li class="spec_list">- 서버의 하드웨어 및 네트워크 구성정보 조회</li>
											<li class="spec_list pb-25">- 서버에 설치된 소프트웨어 정보 조회</li>
										</ul>
									</td>
								</tr>
								<tr>
									<th scope="row" class="category pt-25">사용자 관리</th>
									<td class="text">
										<ul>
											<li class="spec_list">- Unix 서버에서 Group 및 User ID 정보 관리</li>
											<li class="spec_list pb-25">- Group 및 User 추가 및 암호변경</li>
										</ul>
									</td>
								</tr>
								<tr>
									<th scope="row" class="category pt-25">파일송수신(FTP)</th>
									<td class="text">
										<ul>
											<li class="spec_list">- 관리자 PC와 서버 간 파일 및 디렉터리 송수신</li>
											<li class="spec_list pb-25">- FTP 모드에서 디렉터리 새로만들기, 파일삭제, 파일편집 및 실행, 이름변경 등 조작가능</li>
										</ul>
									</td>
								</tr>
								<tr>
									<th scope="row" class="category pt-25">쉘명령어 관리</th>
									<td class="text">
										<ul>
											<li class="spec_list pb-25">- 지정된 서버에 대해 쉘명령어 수행 및 결과 디스플레이</li>
										</ul>
									</td>
								</tr>
								<tr>
									<th scope="row" class="category pt-25">원격 제어</th>
									<td class="text">
										<ul>
											<li class="spec_list pb-25">- Windows 계열 서버의 화면을 관리자 PC에서 제어(마우스, 키보드 조종)</li>
										</ul>
									</td>
								</tr>
								<tr>
									<th scope="row" class="category pt-25">보고서 생성</th>
									<td class="text">
										<ul>
											...
											<li class="spec_list pb-25">- 장애목록 보고서 생성</li>
										</ul>
									</td>
								</tr>
							</table>
					...
					<div class="product_spec">
						...
						<div class="spec_box">
							<table class="spec_table">
								...
								<tr>
									<th scope="row" class="category pt-25">서버</th>
									<td class="text">
										<ul>
											<li class="spec_list">- Windows NT/2000/XP</li>
											<li class="spec_list">- UNIX(Solaris/HP-UX/AIX/DEC_OSF/IRIX/SCO-UNIX/Unixware/Linux)</li>
											<li class="spec_list pb-25">- JAVA System</li>
										</ul>
									</td>
								</tr>
								<tr>
									<th scope="row" class="category pb-25">관리자</th>
