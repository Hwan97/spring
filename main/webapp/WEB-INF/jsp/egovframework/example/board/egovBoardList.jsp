...
<head>
    ...
    <title><spring:message code="title.board" /></title>
...
<body style="text-align:center; margin:0 auto; display:inline; padding-top:100px;">
    <form:form commandName="searchVO" id="listForm" name="listForm" method="post">
        ...
        <div id="content_pop">
        	...
        	<div id="title">
        		<ul>
        			<li><img src="<c:url value='/images/egovframework/example/title_dot.gif'/>" alt=""/><spring:message code="list.board" /></li>
        		</ul>
        	</div>
        	<!-- // 타이틀 -->
        	<div id="search">
        	...
        	<div id="table">
        		<table width="100%" border="0" cellpadding="0" cellspacing="0" summary="카테고리ID, 케테고리명, 사용여부, Description, 등록자 표시하는 테이블">
        			...
        			<tr>
        				...
        				<%-- <th align="center"><spring:message code="title.board.id" /></th> --%>
        				<th align="center"><spring:message code="title.board.name" /></th>
        				<%-- <th align="center"><spring:message code="title.board.useYn" /></th> --%>
        				<th align="center"><spring:message code="title.board.description" /></th>
        				<%-- <th align="center"><spring:message code="title.board.regUser" /></th> --%>
        				<th align="center"><spring:message code="title.board.hitCounter" /></th>
        			</tr>
