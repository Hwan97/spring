...
<head>
    ...
    <title>Board <c:if test="${registerFlag == 'create'}"><spring:message code="button.create" /></c:if>
    ...
    <div id="content_pop">
    	...
    	<table width="100%" border="1" cellpadding="0" cellspacing="0" style="bordercolor:#D3E2EC; bordercolordark:#FFFFFF; BORDER-TOP:#C2D0DB 2px solid; BORDER-LEFT:#ffffff 1px solid; BORDER-RIGHT:#ffffff 1px solid; BORDER-BOTTOM:#C2D0DB 1px solid; border-collapse: collapse;">
    		...
    		<c:if test="${registerFlag == 'modify'}">
        		<tr>
        			<td class="tbtd_caption"><label for="id"><spring:message code="title.board.id" /></label></td>
    		...
    		<tr>
    			<%-- <td class="tbtd_caption"><label for="useYn"><spring:message code="title.board.useYn" /></label></td> --%>
    			<td class="tbtd_content">
    		...
    		<tr>
    			<%-- <td class="tbtd_caption"><label for="regUser"><spring:message code="title.board.regUser" /></label></td> --%>
    			<!-- <td class="tbtd_content"> -->
                    <c:if test="${registerFlag == 'modify'}">
    			...
    			<li>
                    <span class="btn_blue_l">
                        <a href="javascript:fn_egov_save();">
                            <span id="asd"><c:if test="${registerFlag == 'create'}"><spring:message code="button.create" /></c:if> </span>
                            <c:if test="${registerFlag == 'modify'}"><spring:message code="button.modify" /></c:if>
                        </a>
                        <img src="<c:url value='/images/egovframework/example/btn_bg_r.gif'/>" style="margin-left:6px;" alt=""/>
                    </span>
